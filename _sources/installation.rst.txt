...
Virga v2 includes the ability to do aggregates. This requires a different database of optical properties if you are interested in those. Otherwise you are still okay to use the spherical particle only database. For climate modeling (paired with picaso) spherical particle database is recommended. 
